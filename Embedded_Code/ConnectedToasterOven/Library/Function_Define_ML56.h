...
#define    ENABLE_SC0_AUTO_CONVENTION_ERROR_INTERRUPT    SFRS=0;SC0IE|=0x10
#define    ENABLE_SC0_BLOCK_GUARD_TIMER_INTERRUPT        SFRS=0;SC0IE|=0x08
#define    ENABLE_SC0_TRANSFER_ERROR_INTERRUPT           SFRS=0;SC0IE|=0x04
#define    ENABLE_SC0_TRASMIT_BUFFER_EMPTY_INTERRUPT     SFRS=0;SC0IE|=0x02
#define    ENABLE_SC0_RECEIVE_DATA_REACH_INTERRUPT       SFRS=0;SC0IE|=0x01
...
#define    ENABLE_UART1_PRINTF                set_SCON_1_TI_1;UART1PRINTFG=1
#define    DISABLE_UART1_PRINTF               clr_SCON_1_TI_1;UART1PRINTFG=0
