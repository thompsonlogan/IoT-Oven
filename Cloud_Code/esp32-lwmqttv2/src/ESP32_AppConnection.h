...
std::string publicKey = "-----BEGIN PUBLIC KEY-----"
	"MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEltAhfwcL3lOuyFb4TgNJXZ66y/SY\n"
	"mH6QP5Nh3IFDQgtz2XQzOfo0JDNbABzVCi6+hlJqnERXDMdCnAIYPnCKyA==\n"
	"-----END PUBLIC KEY-----";
std::string deviceID = "Embedded_Demo";
...
//call this method at start to set public key for ble server to send to app
...
void bleTask(){
  ...
  setWifiName("Le_Cloud");
  setWifiPassword("CloudDuck");
  ...
  pCharacteristic3->setValue(device_id);
