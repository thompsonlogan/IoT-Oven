...
// By default in CloudIoTCoreMqtt.cpp this topic is subscribed to by the device.
// Any configuration update sent by the cloud will be published over this topic and received by the device.
String CloudIoTCoreDevice::getConfigTopic(){
  return String("/devices/") + device_id + "/config";
}

// By default in CloudIoTCoreMqtt.cpp this topic is subscribed to by the device.
// Any command sent by the cloud will be published over this topic and received by the device.
...
// returns the path to the default telemetry (events) topic. A subfolder may be added onto this later.
String CloudIoTCoreDevice::getEventsTopic(){
  return String("/devices/") + device_id + "/events";
}

// returns the path to the default state topic. A subfolder may be added onto this later.
